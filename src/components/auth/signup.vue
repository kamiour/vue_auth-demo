    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <p v-if="$v.email.$error && !$v.email.required">This field must not be empty</p>
        </div>
        <div class="input" :class="{invalid: $v.age.$error}">
          <label for="age">Your Age</label>
          <input type="number" id="age" v-model.number="age" @blur="$v.age.$touch()" />
          <p
            v-if="$v.age.$error && !$v.age.minVal"
        ...
        <div class="input" :class="{invalid: $v.password.$error}">
          ...
          <p
            v-if="$v.password.$error && !$v.password.minLen"
          >The password must be at least {{ $v.password.$params.minLen.min }} characters long</p>
        </div>
